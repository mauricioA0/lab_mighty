...
Class NSprite extends CApplicationComponent
{
	...
	public function findFiles(){
		$options = array('fileTypes'=>array('png'));
		// must be an array of folders
		foreach($this->getIconPath() as $iFolder){
			if(!is_dir($iFolder))
				throw new CException("The folder path '$iFolder' does not exist.".$iFolder);
	 ...
	 * @return void
	 */
	public function setImageFolderPath($arrayPaths, $merge=false){
		if ($merge)
