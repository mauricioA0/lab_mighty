...
class PublicacionesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update', 'slug'),
				'users'=>array('@'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete', 'slug'),
				'users'=>array('admin'),
			),
	...
	{
		$model=new Publicaciones('search');
		$publicaciones = Publicaciones::model()->findAll();

		foreach($publicaciones as $publica)
		{
			$modelo = str_replace(' ', '-', $publica->modelos->nombreModelo);

			$publica->slug = $modelo.'-'.$publica->tipoPlan;
			$publica->update();
		}
