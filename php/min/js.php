...
$strJavascriptData .= file_get_contents(__DIR__."/../js/jquery.min.js")." ";
$strJavascriptData .= file_get_contents(__DIR__."/../js/owl.carousel.min.js")." ";
$strJavascriptData .= file_get_contents(__DIR__."/../js/bootstrap.min.js")." ";
$strJavascriptData .= file_get_contents(__DIR__."/../js/jquery.hoverIntent.min.js")." ";
$strJavascriptData .= file_get_contents(__DIR__."/../js/wow.min.js")." ";
$strJavascriptData .= file_get_contents(__DIR__."/../js/main.min.js")." ";
$strJavascriptData .= file_get_contents(__DIR__."/../js/jquery.sticky.min.js")." ";
$strJavascriptData .= file_get_contents(__DIR__."/../js/jquery.fancybox.js")." ";
$strJavascriptData .= file_get_contents(__DIR__."/../js/jQfunciones.min.js")." ";
$strJavascriptData .= file_get_contents(__DIR__."/../js/Actions.min.js")." ";
